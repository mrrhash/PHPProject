...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('admin_assets/assets/css/material-dashboard.css?v=2.1.0') }}" rel="stylesheet" />
...
<body class="dark-edition">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
        ...
        <footer class="text-center text-white bg-dark text-bold" style="margin-top: 100px;"><br><h6>Designed By Hassan Raza with <i class="fa fa-heart text-danger" aria-hidden="true"></i></h6><br></footer>
      <!--   Core JS Files   -->
  ...
  <script src="{{ asset('admin_assets/assets/js/material-dashboard.js?v=2.1.0') }}"></script>
